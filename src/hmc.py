...
class HMC(SimObject):
    ...
    def load_model(self, model):
        ...
        print("Base num messages " + str(self.base_num_messages))
        logger.info('Base num messages: {}'.format(str(self.base_num_messages)))
    # end of load_model()
    ...
    def reduce_scatter_evaluate(self, cur_cycle):
        if self.communication_state != 'reduce-scatter' and len(self.reduce_scatter_schedule) == 0:
            return
