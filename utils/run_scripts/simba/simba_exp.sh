...
outdir=$SIMHOME/HPCA2024/simba/comm
...
do
  ...
  python $SIMHOME/src/simulate.py \
    ...
    --strict-schedule \
    --prioritize-schedule \
    > $outdir/${nn}_dtree_36_error_express.log 2>&1 &
  ...
  python $SIMHOME/src/simulate.py \
      ...
      --prioritize-schedule \
      --load-tree \
      > $outdir/${nn}_multitree_36_error_express.log 2>&1 &
  ...
  python $SIMHOME/src/simulate.py \
      ...
      --kary 5 \
      --radix 4 \
      > $outdir/${nn}_ring2dn_36_error_express.log 2>&1 &
  ...
  python $SIMHOME/src/simulate.py \
      ...
      --strict-schedule \
      --prioritize-schedule \
      > $outdir/${nn}_ring_bi_36_error_express.log 2>&1 &
  ...
  python $SIMHOME/src/simulate.py \
      ...
      --strict-schedule \
      --prioritize-schedule \
      > $outdir/${nn}_ring_36_error_express.log 2>&1 &
  ...
  python $SIMHOME/src/simulate.py \
    ...
    --strict-schedule \
    --prioritize-schedule \
    > $outdir/${nn}_dtree_36_error_express_16.log 2>&1 &
  ...
  python $SIMHOME/src/simulate.py \
      ...
      --prioritize-schedule \
      --load-tree \
      > $outdir/${nn}_multitree_36_error_express_16.log 2>&1 &
  ...
  python $SIMHOME/src/simulate.py \
      ...
      --kary 5 \
      --radix 4 \
      > $outdir/${nn}_ring2dn_36_error_express_16.log 2>&1 &
  ...
  python $SIMHOME/src/simulate.py \
      ...
      --strict-schedule \
      --prioritize-schedule \
      > $outdir/${nn}_ring_bi_36_error_express_16.log 2>&1 &
