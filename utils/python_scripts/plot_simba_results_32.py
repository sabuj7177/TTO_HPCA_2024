...
def draw_graph(ax, folder_path, names, total_nodes, schemes, folder_names, scalesim_config):
    ...
    training_time = [94943410, 1251841, 17052318, 9400243, 1471483, 40658925, 10833550]
...
def main():
    ...
    legend = draw_graph(ax1, folder_path, even_names, 36, schemes_evens, folder_names, 'express')
    ...
    figure.savefig('models_simba_32.pdf', bbox_inches='tight')
