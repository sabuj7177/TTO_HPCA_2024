...
def main():
    ...
    plt.rcParams["figure.figsize"] = [7.50, 7.0]
    ...
    # total_nodes = 64
    # draw_graph(ax1, schemes_evens, even_names, folder_names, ldata, xlabels, total_nodes, folder_path, '8x8 Mesh')
    # ax1[2].set_title("8x8 Mesh", y=-0.25)

    total_nodes = 81
    draw_graph(ax1, schemes_odds, odd_names, folder_names, ldata, xlabels, total_nodes, folder_path, '9x9 Mesh')
    ...
    # figure.tight_layout()
    figure.savefig('new/bandwidth_odd_5.pdf', bbox_inches='tight')
